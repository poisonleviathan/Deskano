...
<form method="post" action="">
    <div style="margin-top:30px; text-align:center;">
        ...
        <p><a style="margin-top:20px; margin-bottom:20px;" href="tutor_contact.php" class="btn btn-primary">Contact Us</a></p>
        ...
        <p><a style="margin-top:20px; margin-bottom:20px; width:5%;" href="tutor_profile.php" class="btn btn-secondary">Back</a></p>
    </div>
</form>
...
if(isset($_POST['submit'])) {
    ...
    $sql = "DELETE FROM tutor WHERE email = '$userEmail'";
