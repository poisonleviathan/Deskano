    ...
    <div class="container" style="padding-top: 8%;">
        ...
        <div id="sign" style=" margin-bottom: 10px;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px; padding: 20px;">
            <div class="signup-container">
                <form class="signup-form" action="tutor_sign_up.php" method="post">
                    <h1>Tutor Sign Up</h1>
...
// Validation checks
if (empty($email) || empty($password) || empty($first_name) || empty($last_name) || empty($dob) || empty($mobile_number) || empty($qualification)) {
    ...
    $checkEmailQuery = "SELECT * FROM tutor WHERE email = '$email'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($dobTimestamp > $currentDate) {
            ...
            $query = "INSERT INTO tutor (email, password, first_name, last_name, dob, mobile, last_qualification) VALUES ('$email', '$hashedPassword', '$first_name', '$last_name', '$dob', '$mobile_number', '$qualification')";
            ...
            if (mysqli_query($conn1, $query)) {
                ...
                echo "<script>window.location.href = 'http://localhost/Deskano/login.php'; </script>";
            } else {
