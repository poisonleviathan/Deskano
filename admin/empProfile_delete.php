...
<form method="post" action="">
    <div style="margin-top:30px; text-align:center;">
        ...
        <p><a style="margin-top:20px; margin-bottom:20px; width:5%;" href="employer_profile.php" class="btn btn-secondary">Back</a></p>
    </div>
</form>
...
if(isset($_POST['submit'])) {
    ...
    $sql = "DELETE FROM employer WHERE email = '$userEmail'";
