...
<style type="text/css">
 ...
 <script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0" style="text-align: center;"> 
      ...
      <input class="form-control form-control-dark w-100" type="text" placeholder="DESKANO" readonly style="text-align: center;" aria-label="deskano">
